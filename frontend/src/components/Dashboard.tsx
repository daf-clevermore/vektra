...
export default function Dashboard({
    ...
    return (
        <div className="flex flex-col h-screen bg-[#0b0b10] text-[#e8e8f0] font-sans overflow-hidden select-none">
            ...
            <header className="h-14 border-b border-[#1a1a24] bg-[#0d0d14] flex items-center justify-between px-3 sm:px-6 shrink-0 z-10">
                {/* Brand Logo & Mobile Sidebar Toggle */}
                <div className="flex items-center gap-2 sm:gap-3">
                    <button
                        onClick={() => setMobileSidebarOpen((o) => !o)}
                        className="p-1.5 rounded-lg text-[#9090a8] hover:text-white hover:bg-[#1f1f2e] md:hidden transition-colors"
                    ...
                    <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-violet-600 via-indigo-500 to-purple-400 flex items-center justify-center shadow-lg shadow-violet-500/20 shrink-0">
                    ...
                    <div>
                        <h1 className="text-sm sm:text-base font-bold tracking-tight text-white flex items-center gap-1.5 sm:gap-2">
                            VEKTRA
                            <span className="hidden xs:inline-block text-[10px] px-1.5 py-0.5 rounded font-mono font-medium bg-violet-500/20 text-violet-300 border border-violet-500/30">
                                AI Canvas
                            </span>
                        </h1>
                    </div>
                ...
                <div className="flex-1 max-w-xs sm:max-w-md mx-2 sm:mx-8">
                    <div className="relative">
                        <svg className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-[#4a4a62]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input
                            ...
                            className="w-full pl-9 sm:pl-10 pr-4 py-1.5 text-xs bg-[#161622] border border-[#262636] rounded-xl text-[#e8e8f0] placeholder-[#4a4a62] focus:outline-none focus:border-violet-500/60 focus:ring-1 focus:ring-violet-500/30 transition-all"
                        />
                        {searchQuery && (
                            <button
                ...
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                    <button
                        ...
                        className="px-2.5 sm:px-3.5 py-1.5 rounded-xl text-xs font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 transition-all shadow-md shadow-violet-600/30 flex items-center gap-1.5"
                    >
            ...
            <div className="flex-1 flex min-h-0 relative">
                ...
                <aside className={`bg-[#0d0d14] border-r border-[#1a1a24] flex flex-col p-4 shrink-0 overflow-y-auto gap-6 z-40 transition-transform duration-300 ${
                    mobileSidebarOpen
                        ? "fixed inset-y-0 left-0 w-64 shadow-2xl"
                        : "hidden md:flex w-60"
                }`}>
                    {/* Mobile Header Close Button */}
                    <div className="flex items-center justify-between md:hidden pb-2 border-b border-[#1a1a24]">
                        <span className="text-xs font-bold text-white uppercase tracking-wider">Navigasi</span>
                        <button
                            onClick={() => setMobileSidebarOpen(false)}
                            className="p-1 rounded text-[#808098] hover:text-white"
                        >
                            ✕
                        </button>
                    </div>
                ...
                <main className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-8 sm:space-y-10 min-h-0">
                    {/* ── 1. Hero Banner ────────────────────────────────────────────── */}
                    <div className="relative rounded-3xl overflow-hidden p-5 sm:p-8 border border-violet-500/20 shadow-2xl bg-gradient-to-r from-[#201235] via-[#141228] to-[#0d0d18]">
