                                            ...
                                            <div className="p-3.5 flex flex-col justify-between flex-1 gap-2">
                                                <div>
                                                    {isEditing ? (
                                                        ...
                                                        <h4
                                                            onClick={() => onSelectProject(p.id)}
                                                            className="text-xs font-semibold text-[#e8e8f0] group-hover:text-violet-300 transition-colors truncate cursor-pointer"
                                                            title={p.name}
                                                        >
                                                            {p.name}
                                                        </h4>
                                                ...
                                                {/* Action Bar */}
                                                <div className="pt-2 border-t border-[#1c1c28] flex items-center justify-end gap-1">
                                                    <button
